...
legend("topright",pch=1,col=c("black","red","blue"),legend=c("Sub-metering_1","Sub_metering_2","Sub_metering_3"),cex=0.75)
##    graph3
plot(data$Voltage,ylab="Voltage",sub="datetime",xaxt="n", type="n")
lines(data$Voltage,col="black")
axis(1,at=c(1,1440,2880),labels=c("Thu","Fri","Sat"))
axis(2,at=c(234,236,238,240,242,244,246),labels=c("234","238","242","246"))
##    graph4
plot(data$Global_reactive_power,ylab="Global_reactive_power",sub="datetime",xaxt="n", type="n")
lines(data$Global_reactive_power,col="black")
axis(1,at=c(1,1440,2880),labels=c("Thu","Fri","Sat"))
